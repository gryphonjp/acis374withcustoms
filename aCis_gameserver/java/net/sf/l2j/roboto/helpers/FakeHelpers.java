package net.sf.l2j.roboto.helpers;
...
import net.sf.l2j.roboto.FakePlayerNameManager;
import net.sf.l2j.roboto.ai.AdventurerAI;
import net.sf.l2j.roboto.ai.ArchmageAI;
import net.sf.l2j.roboto.ai.CardinalAI;
import net.sf.l2j.roboto.ai.DominatorAI;
import net.sf.l2j.roboto.ai.DreadnoughtAI;
import net.sf.l2j.roboto.ai.DuelistAI;
import net.sf.l2j.roboto.ai.FakePlayerAI;
import net.sf.l2j.roboto.ai.FallbackAI;
import net.sf.l2j.roboto.ai.GhostHunterAI;
import net.sf.l2j.roboto.ai.GhostSentinelAI;
import net.sf.l2j.roboto.ai.GrandKhavatariAI;
import net.sf.l2j.roboto.ai.MoonlightSentinelAI;
import net.sf.l2j.roboto.ai.MysticMuseAI;
import net.sf.l2j.roboto.ai.SaggitariusAI;
import net.sf.l2j.roboto.ai.SoultakerAI;
import net.sf.l2j.roboto.ai.StormScreamerAI;
import net.sf.l2j.roboto.ai.TitanAI;
import net.sf.l2j.roboto.ai.WindRiderAI;
